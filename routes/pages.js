...
router.get('/', function (req, res, next) {
  res.render('index', { title: '', iconType: 'jpeg', icon: 'bsce.jpg', themeColor: '#0F3280', bodyAttr: " onload='startStars(1000)'", img: 'bsce.jpg', imgType: 'jpg', imgWidth: '100', imgHeight: '100', pageURL: '', desc: 'Her şeyi çeviren ekip!' })
})

router.get('/ceviriler', function (req, res, next) {
  res.render('translations', { title: 'Çeviriler | ', iconType: 'jpeg', icon: 'bsce.jpg', themeColor: '#0F3280', bodyAttr: " onload='startStars(1000)'", img: 'bsce.jpg', imgType: 'jpg', imgWidth: '100', imgHeight: '100', pageURL: '/ceviriler', desc: 'Çevirilerimiz!' })
})

router.get('/hakkimizda', function (req, res, next) {
  res.render('about_us', { title: 'Hakkımızda | ', iconType: 'jpeg', icon: 'bsce.jpg', themeColor: '#0F3280', bodyAttr: " onload='startStars(1000)'", img: 'bsce.jpg', imgType: 'jpg', imgWidth: '100', imgHeight: '100', pageURL: '/hakkimizda', desc: 'Hakkımızda :3' })
})
...
router.get('/ceviri/the_aftermath', function (req, res, next) {
